...
pub fn new_proven_hash_map<K: ProvenEq + View + Hash, V>() -> (result: HashMapWithView<K, V>)
...
/// Use HashMap with i32 keys (which implement ProvenEq).
pub fn use_i32_hash_map() {
...
/// Use HashMap<i32, Unit> - essentially a HashSet
pub fn use_i32_to_unit_map() {
